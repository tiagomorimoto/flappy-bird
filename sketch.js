...
function preload()
{
  pombaAnimation = loadAnimation ("flappy-bird.png", "flappy-bird-2.png", "flappy-bird-3.png");
...
function draw() 
{
  ...
  if (gameState === SERVE)
  {
    ...
    text("Procione ESPAÇO para começar", 500, 300);
...
function spawnObstacles()
{
  if (frameCount % 60 === 0)
  {
    ...
    switch(rand)
    {
    case 1: obstacleB.addImage (canoB1);
          ...
          break;
    case 2: obstacleB.addImage (canoB2);
          ...
          obstacleB.lifetime = 360 ;             
          break;
    case 3: obstacleB.addImage (canoB3);
